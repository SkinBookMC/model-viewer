    ...
    const B = function() {
      ...
      return function(E, T) {
        ...
        if (e.object.isPerspectiveCamera) {
          ...
          let Z = t.length();
          Z *= Math.tan(e.object.fov / 2 * Math.PI / 180), B(2 * E * Z / v.clientHeight, e.object.matrix), X(2 * T * Z / v.clientHeight, e.object.matrix);
        } else
          e.object.isOrthographicCamera ? (B(E * (e.object.right - e.object.left) / e.object.zoom / v.clientWidth, e.object.matrix), X(T * (e.object.top - e.object.bottom) / e.object.zoom / v.clientHeight, e.object.matrix)) : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."), e.enablePan = !1);
      };
    }();
    function V(t) {
...
class dt {
  ...
  createOutlineBox(o, i, e) {
    const n = new He({
      ...
      color: o,
      linewidth: 20
    }), s = new Ge(e.x, e.y, e.z), f = new Be(s), r = new Xe(f, n);
